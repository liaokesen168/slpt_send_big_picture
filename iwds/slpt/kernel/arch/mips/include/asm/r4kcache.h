...
{									\
	...
	unsigned long end = start + CONFIG_SYS_##desc##_WAYSIZE;	\
	unsigned long ws_inc = 1UL << CONFIG_SYS_##desc##_WAYBIT;	\
	unsigned long ws_end = CONFIG_SYS_##desc##_WAYS <<		\
	                       CONFIG_SYS_##desc##_WAYBIT;		\
...
static inline void prot##blast_##pfx##cache##_range(unsigned long start, \
						    unsigned long end)	\
{									\
	unsigned long lsize = CONFIG_SYS_##desc##_LINE_SIZE;			\
