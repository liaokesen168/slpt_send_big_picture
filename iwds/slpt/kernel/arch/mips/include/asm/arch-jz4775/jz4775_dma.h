...
#ifndef __JZ4780_DMA_H__
#define __JZ4780_DMA_H__
...
typedef int (*jz4780_dma_filter_t)(jz4780_dma_chan_t *dma_chan);

extern jz4780_dma_chan_t *jz4780_dma_alloc_chan(jz4780_dma_filter_t filter);
extern void jz4780_dma_release_chan(jz4780_dma_chan_t *chan);
extern void jz4780_dma_chan_dump(jz4780_dma_chan_t *chan);
