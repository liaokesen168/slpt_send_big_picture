...
#ifndef __JZ4780_TIME_H__
#define __JZ4780_TIME_H__
...
/* TCU (Timer Counter Unit) */
struct jz4780_tcu_regs {
	volatile u32 padding3[0x10 / sizeof(u32)];
	volatile u32 ter;	/* 0x10  Timer Counter Enable Register */
	volatile u32 tesr;	/* 0x14  Timer Counter Enable Set Register */
	volatile u32 tecr;	/* 0x18  Timer Counter Enable Clear Register */
	volatile u32 tsr;	/* 0x1C  Timer Stop Register */
	volatile u32 tfr;	/* 0x20  Timer Flag Register */
	volatile u32 tfsr;	/* 0x24  Timer Flag Set Register */
	volatile u32 tfcr;	/* 0x28  Timer Flag Clear Register */
	volatile u32 tssr;	/* 0x2C  Timer Stop Set Register */
	volatile u32 tmr;	/* 0x30  Timer Mask Register */
	volatile u32 tmsr;	/* 0x34  Timer Mask Set Register */
	volatile u32 tmcr;	/* 0x38  Timer Mask Clear Register */
	volatile u32 tscr;	/* 0x3C  Timer Stop Clear Register */

	volatile u32 tdfr0;	/* 0x40  Timer Data Full Register */
	volatile u32 tdhr0;	/* 0x44  Timer Data Half Register */
	volatile u32 tcnt0;	/* 0x48  Timer Counter Register */
	volatile u32 tcsr0;	/* 0x4C  Timer Control Register */
	volatile u32 tdfr1;	/* 0x50 */
	volatile u32 tdhr1;	/* 0x54 */
	volatile u32 tcnt1;	/* 0x58 */
	volatile u32 tcsr1;	/* 0x5C */
	volatile u32 tdfr2;	/* 0x60 */
	volatile u32 tdhr2;	/* 0x64 */
	volatile u32 tcnt2;	/* 0x68 */
	volatile u32 tcsr2;	/* 0x6C */
	volatile u32 tdfr3;	/* 0x70 */
	volatile u32 tdhr3;	/* 0x74 */
	volatile u32 tcnt3;	/* 0x78 */
	volatile u32 tcsr3;	/* 0x7C */
	volatile u32 tdfr4;	/* 0x80 */
	volatile u32 tdhr4;	/* 0x84 */
	volatile u32 tcnt4;	/* 0x88 */
	volatile u32 tcsr4;	/* 0x8C */
	volatile u32 tdfr5;	/* 0x90 */
	volatile u32 tdhr5;	/* 0x94 */
	volatile u32 tcnt5;	/* 0x98 */
	volatile u32 tcsr5;	/* 0x9C */
};

void init_tcu2(void);
void update_tcu2(unsigned int);
