...
int boe_tft320320_res_init(void) {
	pr_debug("boe_tft320320_res_init called\n");
	return 0;
}

int boe_tft320320_power_on(int on) {
	pr_debug("boe_tft320320_power_on called\n");
	return 0;
}

int boe_tft320320_update_mode(int update) {
	...
	pr_debug("boe_tft320320_update_mode called\n");
