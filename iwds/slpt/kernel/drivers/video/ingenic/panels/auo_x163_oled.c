...
int auo_x163_res_init(void) {
	pr_debug("auo_x163_res_init called\n");
	return 0;
}

int auo_x163_power_on(int on) {
	pr_debug("auo_x163_power_on called\n");
	return 0;
}

int auo_x163_update_mode(int update) {
	...
	pr_debug("auo_x163_update_mode called\n");
