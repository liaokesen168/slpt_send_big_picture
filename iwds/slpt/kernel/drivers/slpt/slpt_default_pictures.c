...
#define PIC_SIZE_MEDIUM       (8 * 1024)
#define PIC_SIZE_LARGE        (20 * 1024)
#define PIC_SIZE_SMALL        (4 * 1024)
#define PIC_SIZE_SMALLEST     (2 * 1024)
#define PIC_SIZE_WEEK         (8 * 1024)

#define PIC_SIZE_LOW_BATTERY_LOW  (4 * 1024)
#define PIC_SIZE_CHARGEFULL       (4 * 1024)
#define PIC_SIZE_CHARGE           (4 * 1024)
#define PIC_SIZE_TIME_SEP         (8 * 1024)
#define PIC_SIZE_DATE_SEP         (2 * 1024)
#define PIC_SIZE_MON_NAME         (4 * 1024)
#define PIC_SIZE_DAY_NAME         (4 * 1024)
#define PIC_SIZE_WEEK_NAME        (4 * 1024)
#define PIC_SIZE_SECOND_HANDER    (40 * 1024)
#define PIC_SIZE_MINUTE_HANDER    (40 * 1024)
#define PIC_SIZE_HOUR_HANDER      (40 * 1024)
#define PIC_SIZE_WEEK_HANDER      (40 * 1024)
#define PIC_SIZE_WEEK_BACKGROUND  (100 * 1024)
#define PIC_SIZE_MONTH_HANDER      (40 * 1024)
#define PIC_SIZE_MONTH_BACKGROUND  (100 * 1024)
#define PIC_SIZE_SECOND_BACKGROUND  (100 * 1024)
#define PIC_SIZE_MINUTE_BACKGROUND  (100 * 1024)
#define PIC_SIZE_HOUR_BACKGROUND  (100 * 1024)
#define PIC_SIZE_BACKGROUND       (302 * 1024)
...
SLPT_CORE_INIT_ONETIME(default_pictures_init_onetime);
